...
$sql = "SELECT *FROM usuarios where usu_niv = 4";
                    ...
                    <table id="minhaTabela">
                        ...
                        <?php
                            while ($user_data = $result->fetch(PDO::FETCH_ASSOC)) {
                                echo "<tr>";
                                echo "<td data-titulo='#'>" . $user_data['usu_id'] . "</td>";
                                echo "<td data-titulo='Nome'>" . $user_data['usu_nome'] . "</td>";
                                echo "<td data-titulo='Telefone'>" . $user_data['usu_login'] . "</td>";
